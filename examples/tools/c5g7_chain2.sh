...
LOG=examples/logs/c5g7_sweep.log
ASMPID=48012
...
python3 -u examples/tools/c5g7_probe.py 2 16 1e-10 > examples/logs/c5g7_qc_M16_S2.log 2>&1
RC=$?
...
if [ $RC -eq 137 ]; then
  ...
  python3 -u examples/tools/c5g7_probe.py 3 16 1e-10 > examples/logs/c5g7_qc_M16_S3.log 2>&1
